...
export async function startSupervisor(tracker, options = {}) {
  ...
  const service = managedProcess("supervisor", globalThis.process.execPath, [join(supervisorRoot, "dist", "index.js")], {
    ...
    env: sanitizedEnvironment({
      ...
      FAKE_HERDR_STAGE_TIMEOUT_PROMPT: options.fakeHerdrStageTimeoutPrompt === true ? "true" : "false",
      FAKE_HERDR_COLLAPSE_STAGED_PROMPT: options.fakeHerdrCollapseStagedPrompt === true ? "true" : "false",
